...
#ifndef SummaryAnalysis_h
#define SummaryAnalysis_h
...
class SummaryAnalysis : public AnalysisBase {
public :

   CMS            *fCMS;

   SummaryAnalysis(TTree *tree=0);
   virtual ~SummaryAnalysis();
   virtual void     Loop();
...
#ifdef SummaryAnalysis_cxx
SummaryAnalysis::SummaryAnalysis(TTree *tree)
{
...
#endif // #ifdef SummaryAnalysis_cxx
