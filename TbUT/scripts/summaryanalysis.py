...
myoutpath = "/afs/cern.ch/work/m/mrudolph/public/testbeam/summary/"#"/afs/cern.ch/work/m/mrudolph/public/AdapterAnalysis/"
if not os.path.exists(myoutpath):
    os.makedirs(myoutpath)
os.environ['MYOUTPUTPATH'] = myoutpath
os.environ['BIASV'] = "300V"
...
ROOT.gROOT.ProcessLine(".L SummaryAnalysis.C+");
