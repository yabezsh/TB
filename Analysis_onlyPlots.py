...
shFile = open(os.environ["KEPLERROOT"]+"/../runPlots_"+os.environ["RUNNUMBER"]+".sh","w")
...
shFile.close()
subprocess.call("chmod +x "+os.environ["KEPLERROOT"]+"/../runPlots_"+os.environ["RUNNUMBER"]+".sh",shell=True)
os.system('/$KEPLERROOT/../runPlots_'+os.environ["RUNNUMBER"]+'.sh')
...
if os.path.exists(os.environ["KEPLERROOT"]+"/../runPlots_"+os.environ["RUNNUMBER"]+".sh"):os.system("mv "+os.environ["KEPLERROOT"]+"/../runPlots_"+os.environ["RUNNUMBER"]+".sh  "+outputPath+'/'+boardName+'/'+PA+'/output_'+os.environ["RUNNUMBER"]+'/\n')
